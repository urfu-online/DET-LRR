...
urlpatterns = [
    ...
    path("experts/detail/<str:slug>/", view=expert_detail_view, name="expert_detail"),
    path("experts/update/<str:slug>/", view=expert_update_view, name="expert_update"),
    path("experts/create/", view=expert_create_view, name="expert_create"),
