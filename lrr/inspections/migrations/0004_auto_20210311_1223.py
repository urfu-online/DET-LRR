    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('expert', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='users.expert',
                ...
                ('polymorphic_ctype',
                 models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.CASCADE,
                                   related_name='polymorphic_inspections.checklistbase_set+',
        ...
        migrations.AddField(
            ...
            field=models.TextField(blank=True,
                                   ...
                                   null=True, verbose_name='Выбор типа вопроса'),
        ),
        migrations.AddField(
            model_name='question',
            name='type',
            field=models.CharField(
                choices=[('text', 'text (multiple line)'), ('short-text', 'short text (one line)'), ('radio', 'radio'),
                         ('select', 'select'), ('select-multiple', 'Select Multiple'), ('select_image', 'Select Image'),
                         ('integer', 'integer'), ('float', 'float'), ('date', 'date')], default='text', max_length=200,
                verbose_name='Тип'),
        ),
        ...
        migrations.AlterField(
            model_name='checklist',
            name='protocol',
            field=models.CharField(blank=True, max_length=424, null=True,
                                   verbose_name='№ Протокола учебно-методического совета института'),
        ),
        migrations.AlterField(
            model_name='checklist',
            name='type',
            field=models.CharField(blank=True, choices=[('METHODICAL', 'Методическая'), ('CONTENT', 'Содержательная'),
                                                        ('TECH', 'Техническая'),
                                                        ('NO_TYPE', 'Отсутствует тип экспертизы')], default='NO_TYPE',
                                   max_length=30, null=True, verbose_name='Тип чек-листа'),
        ),
        migrations.AlterField(
            model_name='question',
            name='title',
            ...
            fields=[
                ('checklistbase_ptr',
                 models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True,
                                      primary_key=True, serialize=False, to='inspections.checklistbase')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_updated', models.DateTimeField(auto_now=True, verbose_name='Последние обновление')),
                ('checklist',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='inspections.checklistbase',
                                   verbose_name='Чек-лист эеспертизы')),
                ('polymorphic_ctype',
                 models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.CASCADE,
                                   related_name='polymorphic_inspections.questionbase_set+',
                                   to='contenttypes.contenttype')),
            ],
            options={
        ...
        migrations.AlterField(
            model_name='question',
            name='checklist',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='inspections.checklistbase',
                                    verbose_name='Чек-лист эеспертизы'),
        ),
    ]
