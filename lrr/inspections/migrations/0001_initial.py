    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.PositiveSmallIntegerField(
                        blank=True, null=True, verbose_name="КУРС_ЭОР"
                    ),
                ),
                (
                    "location",
                    models.PositiveSmallIntegerField(
                        blank=True, null=True, verbose_name="Внеш_Внутр"
                    ),
                ),
                (
                    "interaction",
                    models.PositiveSmallIntegerField(
                        blank=True,
                        null=True,
                        verbose_name="Тип интерактивности (Автоматизированный/Не интерактивный/С участием преподавателя)",
                    ),
                ),
                (
                    "compliance",
                    models.PositiveSmallIntegerField(
                        blank=True,
                        null=True,
                        verbose_name="Соответствие содержанию дисциплины (Полностью/Частично)",
                    ),
                ),
                (
                    "rating",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "order",
                    models.IntegerField(
                        blank=True, null=True, verbose_name="Порядок отображения"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "date",
                    models.DateField(
                        blank=True, null=True, verbose_name="Дата проведения экспертизы"
                    ),
                ),
                (
                    "protocol",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "date",
                    models.DateTimeField(
                        blank=True, null=True, verbose_name="Дата заявки"
                    ),
                ),
                (
                    "date_end",
                    models.DateTimeField(
                        blank=True,
                        null=True,
                        verbose_name="Срок действия статуса экспертизы",
                    ),
                ),
                (
                    "file",
                ...
                (
                    "remarks",
                    models.TextField(
                        blank=True, verbose_name="Замечания и рекомендации комиссии"
                    ),
                ),
                (
                    "status",
                ...
                (
                    ...
                    models.CharField(
                        ...
                        max_length=30,
                        verbose_name="Категория интерактивности",
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "text",
                    models.TextField(null=True, verbose_name="Наименование показателя"),
                ),
                (
                    "order",
                ...
                (
                    "per_discipline",
                    models.BooleanField(
                        default=False, verbose_name="Для каждой дисциплины"
                    ),
                ),
                (
                    "choices",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "title",
                    models.CharField(
                        db_index=True, max_length=1024, verbose_name="Наименование"
                    ),
                ),
                (
                    "group",
                    models.CharField(
                        choices=[
                            ...
                            (
                                "struct",
                                "Соответствие структуры и содержания ЭОР требованиям конкретных дисциплин ОП",
                            ),
                            (
                                "tech",
            ...
            fields=[
                ...
                (
                    ...
                    django_better_admin_arrayfield.models.fields.ArrayField(
                        ...
                        null=True,
                        size=None,
                        verbose_name="Допустимые значения",
                    ),
                ),
                (
                    "allowed_num_values",
                    django.contrib.postgres.fields.ranges.IntegerRangeField(
                        blank=True,
                        null=True,
                        verbose_name="Диапазон допустимых числовых значений",
                    ),
                ),
                (
                    "exclude_values",
                    django_better_admin_arrayfield.models.fields.ArrayField(
                        ...
                        null=True,
                        size=None,
                        verbose_name="Исключаемые значения",
                    ),
                ),
                (
                    "available",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "have_conflicts",
                    models.BooleanField(
                        default=False, verbose_name="Имеются противоречия"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.TextField(
                        blank=True, null=True, verbose_name="Тело статуса"
                    ),
                ),
                (
                    "date",
                    models.DateTimeField(
                        blank=True, null=True, verbose_name="Дата выставления статуса"
                    ),
                ),
                (
                    "expertise_request",
