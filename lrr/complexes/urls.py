...
urlpatterns = (
    ...
    path("ComplexParentComponent/create/<uuid:pk>/", views.ComplexParentComponentCreateView.as_view(),
         name="complexes_ComplexParentComponent_create"),
    # path("ComplexParentComponent/update/<uuid:pk>/", views.ComplexParentComponentUpdateView.as_view(),
    #      name="complexes_ComplexParentComponent_update"),
    path("ComplexParentComponent/list/<uuid:pk>/", views.ComplexParentComponentListView.as_view(),
         name="complexes_ComplexParentComponent_list"),
    ...
    path("ComplexParentComponent/delete/<uuid:pk>/", views.ComplexParentComponentDeleteView.as_view(),
         name="complexes_ComplexParentComponent_delete"),
    ...
    path("cell/list/<uuid:pk>/", views.ThematicPlanDetailView.as_view(),
         name="complexes_ThematicPlan_detail"),
