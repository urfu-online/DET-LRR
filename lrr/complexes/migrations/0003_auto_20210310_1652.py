    ...
    operations = [
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT,
                                    related_name='owner_digital_complex', to='users.person', verbose_name='Владелец'),
        ),
        migrations.AddField(
            model_name='digitalcomplex',
            name='results_edu',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE,
                                    to='complexes.digitalcomplex', verbose_name='ЭУМК'),
        ),
        migrations.AddField(
            model_name='componentcomplex',
            name='polymorphic_ctype',
            field=models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.CASCADE,
                                    related_name='polymorphic_complexes.componentcomplex_set+',
        ...
        migrations.AddField(
            ...
            name='cell',
            field=models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='complexes.cell',
                                    verbose_name='Ячейка комплекса'),
        ),
        migrations.AddField(
            model_name='assignmentacademicgroup',
            name='academic_group',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT,
                                    to='users.academicgroup', verbose_name='Академическая группа'),
        ),
        migrations.AddField(
            model_name='assignmentacademicgroup',
            name='digital_complex',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE,
                                    to='complexes.digitalcomplex', verbose_name='ЭУМКи'),
        ),
        migrations.AddField(
            model_name='assignmentacademicgroup',
            name='subject',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT,
                                    to='repository.subject', verbose_name='Дисциплина'),
        ),
        migrations.AddField(
            model_name='resourcecomponent',
            name='digital_resource',
            field=models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE,
                                    to='repository.digitalresource', verbose_name='ЭОР'),
        ),
        migrations.AddField(
            model_name='platformcomponent',
            name='platform',
            field=models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='repository.platform',
