    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('semestr',
                 models.CharField(blank=True, choices=[('FIRST', 'Первый семестр'), ('SECOND', 'Второй семестр')],
                                  max_length=50, null=True, verbose_name='Семестр')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_updated', models.DateTimeField(auto_now=True, verbose_name='Последние обновление')),
                ('type',
                 models.CharField(choices=[('ASYNC', 'асинхронные мероприятия'), ('SYNC', 'синхронные мероприятия')],
                                  max_length=50, null=True, verbose_name='Тип ячейки')),
                ...
                ('beg_theme_number',
                 models.PositiveSmallIntegerField(blank=True, verbose_name='Начало диапазонов объединяемых строчек')),
                ('end_theme_number',
                 models.PositiveSmallIntegerField(blank=True, verbose_name='Конец диапазонов объединяемых строчек')),
                ('methodology_description',
                 models.CharField(blank=True, max_length=1024, verbose_name='Методологическое описание')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True, verbose_name='Создано')),
                ('last_updated', models.DateTimeField(auto_now=True, verbose_name='Последние обновление')),
                ('beg_week_number', models.PositiveSmallIntegerField(blank=True,
                                                                     verbose_name='Начало диапазона недель учебного графика ячейки')),
                ('end_week_number', models.PositiveSmallIntegerField(blank=True,
                                                                     verbose_name='Конец диапазона недель учебного графика ячейки')),
                ('edu_form', models.CharField(blank=True, max_length=150,
                                              verbose_name='Форма обучения для которой сотавлен график')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_updated', models.DateTimeField(auto_now=True, verbose_name='Последние обновление')),
                ('title',
                 models.CharField(blank=True, max_length=150, null=True, verbose_name='Наименогвание комплекса')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('componentcomplex_ptr',
                 models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True,
                                      primary_key=True, serialize=False, to='complexes.componentcomplex')),
            ],
            options={
                'abstract': False,
            },
