...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='authors',
            field=models.ManyToManyField(blank=True, related_name='authors_digital_resource', to='users.Person',
                                         verbose_name='Авторы'),
        ),
        migrations.AddField(
            model_name='digitalresource',
            name='conformity_theme',
            field=models.ManyToManyField(blank=True, to='repository.ConformityTheme',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT,
                                    related_name='owner_digital_resource', to='users.person', verbose_name='Владелец'),
        ),
        migrations.AddField(
            model_name='digitalresource',
            name='platform',
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(blank=True, to='repository.ProvidingDiscipline',
                                         verbose_name='ЭОР рекомендован в качестве обеспечения дисциплины'),
        ),
        migrations.AddField(
            model_name='digitalresource',
            name='result_edu',
            field=models.ManyToManyField(blank=True, to='repository.ResultEdu',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='repository.providingdiscipline',
                                    verbose_name='Рекомендация ЭОР в качестве обеспечения дисциплины'),
        ),
        migrations.AddField(
            model_name='conformitytheme',
            name='theme',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='repository.subjecttheme',
