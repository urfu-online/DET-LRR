# Generated by Django 3.0.7 on 2020-09-23 19:20
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('conformity_theme', models.ManyToManyField(blank=True, to='repository.ConformityTheme', verbose_name='Соответствие ЦОР темам дисциплины')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('URL', models.URLField(blank=True, null=True, verbose_name='Ссылка на файл')),
                ('file', models.FileField(blank=True, null=True, upload_to='upload/files')),
                ('digital_resource', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='repository.DigitalResource', verbose_name='Паспорт ЦОР')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('competence', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='repository.Competence', verbose_name='Компетенция')),
            ],
            options={
