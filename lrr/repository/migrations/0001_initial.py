    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True, verbose_name='Создано')),
                ('last_updated', models.DateTimeField(auto_now=True, verbose_name='Последние обновление')),
                ('uni_id', models.CharField(blank=True, db_index=True, max_length=64, null=True)),
                ('title', models.CharField(db_index=True, max_length=150, verbose_name='Наименование')),
                ('code', models.CharField(db_index=True, max_length=8, verbose_name='Код направления')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True, verbose_name='Создано')),
                ('last_updated', models.DateTimeField(auto_now=True, verbose_name='Последние обновление')),
                ('title', models.CharField(db_index=True, max_length=450, verbose_name='Наименование')),
                ('_cipher', models.CharField(blank=True, max_length=5, null=True, verbose_name='Шифр ОП')),
                ('short_description', models.CharField(blank=True, max_length=300, null=True, verbose_name='Короткое описание')),
                ('description', models.TextField(blank=True, null=True, verbose_name='Описание')),
                ('standard', models.CharField(blank=True, max_length=9, null=True, verbose_name='Стандарт')),
                ('edu_level', models.CharField(blank=True, max_length=32, null=True, verbose_name='Уровень подготовки')),
                ('admission_years', django.contrib.postgres.fields.ArrayField(base_field=models.PositiveSmallIntegerField(blank=True, null=True), null=True, size=None)),
                ('approve_year', models.PositiveSmallIntegerField(blank=True, null=True, verbose_name='Год утверждения')),
                ('head', models.CharField(blank=True, max_length=300, null=True, verbose_name='Руководитель')),
                ('site_admin', models.CharField(blank=True, max_length=300, null=True, verbose_name='Администратор сайта ОП')),
                ('direction', auto_prefetch.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='programs', to='repository.direction', verbose_name='Направление подготовки')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True, verbose_name='Создано')),
                ('last_updated', models.DateTimeField(auto_now=True, verbose_name='Последние обновление')),
                ('tag', auto_prefetch.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='repository.subject', verbose_name='Дисциплина')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('URL', 'URL'), ('FILE', 'Файл')], max_length=8, null=True, verbose_name='Тип')),
                ('digital_resource', auto_prefetch.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='repository.digitalresource', verbose_name='Паспорт ЭОР')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('competence', auto_prefetch.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='repository.competence', verbose_name='Компетенция')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True, verbose_name='Создано')),
                ('last_updated', models.DateTimeField(auto_now=True, verbose_name='Последние обновление')),
                ('tag', auto_prefetch.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='repository.eduprogram', verbose_name='Образовательная программа')),
            ],
            options={
