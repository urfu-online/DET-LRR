...
urlpatterns = (
    ...
    path("ExpertiseStatus/create/", views.ExpertiseStatusCreateView.as_view(),
         name="repository_ExpertiseStatus_create"),
    path("repository/ExpertiseStatus/detail/<uuid:pk>/", views.ExpertiseStatusDetailView.as_view(),
         name="repository_ExpertiseStatus_detail"),
    path("ExpertiseStatus/update/<uuid:pk>/", views.ExpertiseStatusUpdateView.as_view(),
         name="repository_ExpertiseStatus_update"),
    ...
    path("ProvidingDiscipline/", views.ProvidingDisciplineListView.as_view(),
         name="repository_ProvidingDiscipline_list"),
    path("ProvidingDiscipline/create/", views.ProvidingDisciplineCreateView.as_view(),
         name="repository_ProvidingDiscipline_create"),
    path("ProvidingDiscipline/detail/<int:pk>/", views.ProvidingDisciplineDetailView.as_view(),
         name="repository_Providing_discipline_detail"),
    path("ProvidingDiscipline/update/<int:pk>/", views.ProvidingDisciplineUpdateView.as_view(),
         name="repository_ProvidingDiscipline_update"),
    ...
    path("ConformityTheme/create/", views.ConformityThemeCreateView.as_view(),
         name="repository_ConformityTheme_create"),
    path("ConformityTheme/detail/<int:pk>/", views.ConformityThemeDetailView.as_view(),
         name="repository_ConformityTheme_detail"),
    path("ConformityTheme/update/<int:pk>/", views.ConformityThemeUpdateView.as_view(),
         name="repository_ConformityTheme_update"),
    ...
    path("SubjectTheme/detail/<int:pk>/", views.SubjectThemeDetailView.as_view(),
         name="repository_SubjectTheme_detail"),
    path("SubjectTheme/update/<int:pk>/", views.SubjectThemeUpdateView.as_view(),
         name="repository_SubjectTheme_update"),
    ...
    path("ThematicPlan/detail/<int:pk>/", views.ThematicPlanDetailView.as_view(),
         name="repository_ThematicPlan_detail"),
    path("ThematicPlan/update/<int:pk>/", views.ThematicPlanUpdateView.as_view(),
         name="repository_ThematicPlan_update"),
